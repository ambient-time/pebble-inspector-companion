...
object SignalHistory {
    ...
    private val sourceAliases = mapOf(
        ...
        "healthconnect.resting_heart_rate" to listOf("resting heart rate"), "healthconnect.hrv_rmssd" to listOf("hrv", "variability", "rmssd"),
        "cellular" to listOf("cellular", "cell", "tower", "towers", "lte", "5g", "carrier"),
        "places.nearby" to listOf("nearby", "places", "address", "business", "cafe", "shop"),
        "location.radio" to listOf("radio location", "geolocation", "estimate"),
